...
class RecetaControllerUnitTest {
  ...
  void testGetAllRecetas() {
    List<RecetaResponseDTO> list = List.of(
        new RecetaResponseDTO("RTEST-001", "Milanesa", "Descripcion test", LocalDateTime.now(), "Id creador"));
...
*/
  ...
  void testUpdateReceta() {
    ...
    RecetaResponseDTO testResponseDTO = new RecetaResponseDTO("COD-001", "Milanesa Napolitana", "desc",
        LocalDateTime.now(),
        "Id creador");
